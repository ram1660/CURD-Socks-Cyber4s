...
import { getIds, LocationHistory, ServerAnswer, TableTypes, updateLocationHistory } from '../serverHandler';
...
export default class EditLocationHistory extends Component<propsTypes, stateTypes> {
  ...
  private async onSubmit(): Promise<void> {
    ...
    const answer = await updateLocationHistory(locationHistoryData, this.props.id);
  ...
  render() {
    return (
      <div className={styles['option-container']}>
        ...
        <button className={styles['apply-button']} onClick={() => this.onSubmit()}>Change location history</button>
