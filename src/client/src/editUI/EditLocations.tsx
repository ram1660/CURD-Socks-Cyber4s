...
import { ServerAnswer, Location, updateLocation } from '../serverHandler';
...
export default class EditLocations extends Component<propsTypes, stateTypes> {
    ...
    private async onSubmit(): Promise<void> {
        ...
        const answer = await updateLocation(locationData, this.props.id);
    ...
    render() {
        return (
            <div className={styles['option-container']}>
                ...
                <button className={styles['apply-button']} onClick={() => this.onSubmit()}>Change location</button>
