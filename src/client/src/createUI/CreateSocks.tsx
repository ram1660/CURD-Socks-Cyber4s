...
import { Socks, ServerAnswer, createSocks, getIds, TableTypes } from '../serverHandler';
...
export default class CreateSocks extends Component<propsTypes, stateTypes> {
  ...
  private async onSubmit(): Promise<void> {
    ...
    const answer = await createSocks(locationHistoryData);
