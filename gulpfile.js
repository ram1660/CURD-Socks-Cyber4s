...
gulp.task('images', () => {
  return gulp.src(['./src/server/images/*.png', './src/server/images/*.jpg'])
  .pipe(gulp.dest('./dist/images'));
});

// Converts scss to css
gulp.task('scss', () => {
  return gulp.src(['./src/server/**/*.scss ', './src/client/**/*.scss'])
    .pipe(sass())
    .pipe(gulp.dest('./dist'));
});
...
gulp.task('watch-scss', () => {
  return gulp.watch('./src/server/**/*.scss', gulp.series('scss'));
});

// Watch html files
gulp.task('watch-html', () => {
  return gulp.watch(['./src/server/**/*.html'], gulp.series('index'));
});

// Watch tsc files
gulp.task('watch-tsc', () => {
  return gulp.watch(['./dist/tsc/server/**/*.js', './dist/tsc/client/**/*.js'], gulp.series('bundle'));
});

gulp.task('watch-images', () => {
  return gulp.watch(['./dist/images/**/*.png', './dist/images/**/*.jpg'], gulp.series('images'));
});
